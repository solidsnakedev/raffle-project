...
import { Lucid, TxHash, UTxO, Lovelace, Constr, SpendingValidator, Data } from 'lucid-cardano'
  ...
  return (
    <div className="px-10">
      ...
      <div className="mx-40 my-10">
        ...
        <button className="btn btn-secondary m-5" onClick={() => { getUtxos() }}>Get utxos</button>
      </div>
    </div>
  )
}
