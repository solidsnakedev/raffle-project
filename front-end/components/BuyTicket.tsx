...
import { buyTicket } from '../endpoints/endpoints'
...
export const BuyTicket = ({ lucid, policy }: Props) => {
    ...
    const handleClick = async () => {
        const result = await buyTicket(lucid, policy)
    ...
    return (
        <div className='flex flex-col justify-center items-center'>
            ...
            <button
                ...
                onClick={() => handleClick()}>Buy Ticket
            </button>
            {error &&
